        ...
        <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    ...
                    <a href="{{ route('admin.roles.create') }}" class="btn btn-primary">
                        ...
                        <span class="text">{{ __('เพิ่มสถานะ') }}</span>
                    </a>
                    @endcan
                </div>
            </div>
                            ...
                            <tr data-entry-id="{{ $role->id }}">
                                ...
                                <td>
                                    <div class="btn-group-sm" style="border-top-left-radius: 0;border-bottom-left-radius: 0;">
                                        ...
                                        <form onclick="return confirm('Are you sure to delete this data? ')" class="d-inline" action="{{ route('admin.roles.destroy', $role->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
